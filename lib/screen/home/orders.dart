...
///TOp one is sliding tabledata///////////////////////////


////////////////List View Products View Show Working one////////////
                          ...
                          if(identical(value.isOrdersLoading, "NOT_STARTED") || identical(value.isOrdersLoading, "LOADING")){
                            ...
                            return Container(
                              child:  ListView.builder(
                                  ...
                                  itemCount: value.vendOrder.orders.length,
                                  itemBuilder: (BuildContext context, int index) {

                                    DateTime createdAt = value.vendOrder.orders[index].createdAt;
                                    String formattedDate = DateFormat.yMMMMd().add_jm().format(createdAt);
                                    print(formattedDate); // This will print the formatted date and time
                                    return   Column(
                                      children: [
                                            ...
                                            child:  Column(
                                              children: [
                                                Row(
                                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                  children: [
                                                    Text(formattedDate, style: fontStyle40012(AppColors.bgBlack),),
                                                    Container(
                                                        ...
                                                        child: Text(value.vendOrder.orders[index].orderStatus.statusName, style: TextStyle(color: AppColors.bgGreen3, fontSize: 12,
                                                  ...
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      child: Column(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          Text(value.vendOrder.orders[index].product.name, style: fontStyleSentences(),),
                                                          const SizedBox(height: 15,),
                                                          Row(
                                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                            children: [
                                                              Text("\u20B9${value.vendOrder.orders[index].product.price.toString()}", style: fontStyle60016(AppColors.bgBlack),),
                                                              Text("\u20B9${value.vendOrder.orders[index].product.comparePrice.toString()}",  style: TextStyle(
                                                                  fontSize: 15,
                                                  ...
                                                  child: Column(
                                                    children: [
                                                      ...
                                                      Container(
                                                          padding: EdgeInsets.only(top: 5, bottom: 5),
                                                          alignment: Alignment.topLeft,
                                                          child: Text("Order ID : ${value.vendOrder.orders[index].order.ordId}", style: fontStyleSentences(),)),

                                                      Container(
                                                          padding: EdgeInsets.only(top: 5, bottom: 5),
                                                          alignment: Alignment.topLeft,
                                                          child: Text(formattedDate, style: fontStyleSentences(),)),
                                                      ...
                                                      //   child: ListView.builder(
                                                      //     shrinkWrap: true,
                                                      //     itemCount: value.vendOrder.orders[index].orderStatus,
                                                      ...
                                                      Container(
                                                        ...
                                                        child: Row(
                                                          ...
                                                          crossAxisAlignment: CrossAxisAlignment.start,
                                                          children: [
                                                            Text(formattedDate, style: fontStyleSentences(),),
                                                            SizedBox(width: 10), // Add spacing between time and status
                                                            Flexible(
                                                              child: Text(value.vendOrder.orders[index].orderStatus.statusName, style: fontStyleSentences(),),
                                                  ...
                                                  children: [
                                                    ...
                                                    Container(
                                                      child: ElevatedButton(
                                                          ...
                                                          }, child: Text( "Reject" , style: fontStyle50012(AppColors.bgWhite),)
                                                      ),
                                                    ),
                                                  ],
                                                )
