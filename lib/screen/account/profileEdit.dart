  ...
  Widget build(BuildContext context) {
    ...
    Widget imageEdit() {
      return Container(
        child: Column(
          children: [
            ///////// ///Another Methos to upload image///////////
            // CircleAvatar(
            //   radius: 60, // Adjust the radius as needed
            //   backgroundImage: AssetImage('assets/profile_image.png'), // Replace with your image path
            // ),
            // SizedBox(height: 10), // Add spacing between the image and upload button
            // ElevatedButton(
            //   onPressed: () {
            ...
            CircleAvatar(
              radius: 60, // Adjust the radius as needed
              backgroundImage: NetworkImage('https://i.pinimg.com/736x/58/e9/31/58e9316498a98b5cea59720016b45dcc.jpg'), // Replace with your image path
              child: IconButton(
                icon: Icon(
                  Icons.camera_alt,
                ...
                onPressed: () {
                  // Handle the camera button tap here
                },
              ),
            )
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          }, child: Text("Save", style: fontStyle60016(AppColors.bgBlack),))
        ],
      ),
      body: SafeArea(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 12,),
                address1("Home Address2 *"),
                const SizedBox(height: 12,),
                fields("Landmark *", "Enter near by landmark"),
                const SizedBox(height: 12,),
                twoButtons(),
                const SizedBox(height: 20,),
                address1("Work Address *"),
                const SizedBox(height: 12,),
                fields("Landmark *", "Enter near by landmark"),
                const SizedBox(height: 12,),
                twoButtons(),
